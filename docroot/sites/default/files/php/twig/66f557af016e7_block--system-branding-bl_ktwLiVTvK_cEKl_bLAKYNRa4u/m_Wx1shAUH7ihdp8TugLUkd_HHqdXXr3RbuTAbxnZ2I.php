...
class __TwigTemplate_0089fa0325a3839cb46ce45bd7eb6714 extends Template
{
  ...
  ";
        ...
        // line 27
        yield "  ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["site_slogan"] ?? null), 27, $this->source), "html", null, true);
        yield "
";
        yield from [];
    }
    ...
    {
        return new Source("", "core/modules/system/templates/block--system-branding-block.html.twig", "/var/www/html/docroot/core/modules/system/templates/block--system-branding-block.html.twig");
    }
